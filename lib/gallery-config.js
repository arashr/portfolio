...
export function applyGalleryConfigToDocument(cfg = activeConfig) {
  ...
  root.style.setProperty('--red-bright', colors.redBright);

  root.style.setProperty('--measure', layout.measure);
  root.style.setProperty('--poster-width', layout.posterWidth || layout.measure);
  const edgeMix = Math.min(0.4, Math.max(0.04, Number(layout.edgeStepMix) || 0.12));
  root.style.setProperty('--edge-mix', `${Math.round(edgeMix * 100)}%`);
  root.style.setProperty('--pad', layout.pad);
  root.style.setProperty('--scroll-offset', layout.scrollOffset);
  ...
  root.style.setProperty('--body-size', typo.bodySize);
  root.style.setProperty('--body-line-height', String(typo.bodyLineHeight));
  root.style.setProperty('--prose-line-height', String(typo.proseLineHeight ?? '1.6'));
  root.style.setProperty('--title-line-height', String(typo.titleLineHeight ?? '1.12'));
  root.style.setProperty(
    '--title-heading-line-height',
    String(typo.titleHeadingLineHeight ?? '0.95')
  );
  root.style.setProperty(
    '--title-face-letter-spacing',
    typo.titleFaceLetterSpacing ?? '0.02em'
  );
  root.style.setProperty('--label-size', typo.labelSize);
  root.style.setProperty('--label-weight', String(typo.labelWeight));
  root.style.setProperty('--label-letter-spacing', typo.labelLetterSpacing);
  root.style.setProperty('--prose-size', typo.proseSize);
  root.style.setProperty('--crumb-size', typo.crumbSize);
  ...
  root.style.setProperty('--code-text', resolveColor(code.text ?? 'paper', cfg));
  ...
  root.style.setProperty('--dark-paper', dark.paper ?? DEFAULT_CONFIG.darkTheme.paper);
  root.style.setProperty('--dark-ink', darkColors.ink);
  root.style.setProperty('--dark-ink-soft', darkColors.inkSoft);
  root.style.setProperty('--dark-ink-mute', darkColors.inkMute);
  root.style.setProperty('--dark-red', darkColors.red);
  root.style.setProperty('--dark-red-bright', darkColors.redBright);
  root.style.setProperty(
